  ...
  <div id="dalos">
    ...
    <div class="bigBoxs">
      ...
      >
        ...
        <el-table-column property="release_time" label="发布时间" align="center"></el-table-column>
        ...
        <el-table-column property="source_from" label="来源" align="center"></el-table-column>
        <el-table-column property="description" label="描述" align="center"></el-table-column>
        <el-table-column property="file_path" label="文件地址" align="center"></el-table-column>
      ...
      <div class="diaTilte">
        ...
        <el-form label-width="130px">
          ...
          <el-form-item label="作者">
            <el-input style="width: 300px;" v-model="msg1.author"></el-input>
          </el-form-item>
          <el-form-item label="来源">
            <el-input style="width: 300px;" v-model="msg1.source_from"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList(data) {
      ...
      var basicURL =
        "/yanghua_edu/api/other_module/document_file/?pg=" +
        this.pages.page +
        "&size=" +
        this.pages.size;
    ...
    delNews(val) {
      ...
      var url = "/yanghua_edu/api/other_module/document_file/";
